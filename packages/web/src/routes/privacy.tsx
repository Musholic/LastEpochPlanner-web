  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section className="py-10 px-4 bg-base-100">
        ...
        <div>
          <p>I am using Plausible Analytics, a privacy-friendly analytics tool, to track overall trends in the usage of my website. Plausible Analytics collects only aggregated information, which does not allow to identify any visitor to my website. For more information, please visit the <a href="https://plausible.io/data-policy">Plausible Analytics Data Policy</a>.</p>
        </div>
      </section>
